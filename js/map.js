 ...
 * Geospatial Engine & Layer Pane Manager
 */
...
export function initMap() {
    ...
    // V9: Strict Layer Panes (Prevents Roads from covering Buildings)
    map.createPane('roads');
    map.getPane('roads').style.zIndex = 200;
    
    map.createPane('buildings');
    map.getPane('buildings').style.zIndex = 300;
...
function updateGPSIndicator(colorClass, text) {
    ...
    indicator.className = 'w-3 h-3 rounded-full transition-colors shadow-sm'; 
